package com.springbootstarterch0306springmvcresolvinguserlocales.demo;
...
import com.springbootstarterch0306springmvcresolvinguserlocales.demo.library.CustomizedErrorAttributes;
import com.springbootstarterch0306springmvcresolvinguserlocales.demo.library.service.BookService;

@SpringBootApplication
public class SpringbootstarterCh0306SpringMvcResolvingUserLocalesApplication implements WebMvcConfigurer {

	public static void main(String[] args) {
		SpringApplication.run(SpringbootstarterCh0306SpringMvcResolvingUserLocalesApplication.class, args);
	}
